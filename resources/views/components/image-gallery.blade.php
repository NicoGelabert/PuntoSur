...
<div x-data="{
    ...
    <!-- Splide Slider -->
    <div {{ $attributes->merge(['class' => 'news_gallery splide']) }}>
    ...
    <template x-if="open && images.length">
        <div class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-80 z-50" id="news_lightbox">
            <div class="relative w-full h-full flex items-center justify-center py-12">
                <!-- Imagen Actual -->
