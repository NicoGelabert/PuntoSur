                        ...
                        <div class="w-full md:w-1/2 md:max-h-[50%] py-8 md:p-4 flex flex-col gap-4">
                            <div>
                                <div class="flex justify-between">
                                    <h5>{{ $project->title }}</h5>
                                    <h4 class="text-gray_300 ml-4">{{ $project->id }}/15</h4>
                                </div>
                                <ul>
                            ...
                            <ul class="hidden md:flex flex-wrap gap-2">
                                ...
                                <li class="mt-1 bg-gray-50 text-xs w-fit rounded-full px-2 py-1 text-black dark:bg-gray_700 dark:text-white">{{ $tag->name }}</li>
                                @endforeach
                            </ul>
                        </div>
                    </li>
